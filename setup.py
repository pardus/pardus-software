...
data_files = [
    ...
    ("/usr/share/pardus/pardus-software/images",
     ["images/rating.svg", "images/rating-unrated.svg", "images/rating-hover-empty.svg", "images/rating-hover-full.svg",
      "images/rating-0.svg", "images/rating-0-3.svg", "images/rating-0-5.svg", "images/rating-0-8.svg",
      "images/rating-1.svg"]),
    ...
    ("/usr/share/pardus/pardus-software/src",
     ["src/Actions.py", "src/AppDetail.py", "src/AppImage.py", "src/AppRequest.py", "src/AutoAptUpdate.py",
      "src/CellRendererButton.py", "src/GnomeComment.py", "src/GnomeRatingServer.py", "src/Group.py", "src/main.py",
