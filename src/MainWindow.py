...
class MainWindow(object):
    def __init__(self, application):
        ...
        self.ui_sortby_combo = self.GtkBuilder.get_object("ui_sortby_combo")
                ...
                if is_installed is not None:
                    if is_installed:
                        ...
                        if is_upgradable:
                            ...
                            listbox = self.create_base_app_widget(app, details)
    ...
    def on_catbutton_clicked(self, button):
        ...
        if self.mda_clicked and self.ui_sortby_combo.get_active() == 1:
            self.ui_sortby_combo.set_active(0)
            self.mda_clicked = False

        if self.mra_clicked and self.ui_sortby_combo.get_active() == 2:
            self.ui_sortby_combo.set_active(0)
            self.mra_clicked = False

        if self.la_clicked and self.ui_sortby_combo.get_active() == 3:
            self.ui_sortby_combo.set_active(0)
            self.la_clicked = False
    ...
    def set_editor_apps(self, count, style=1):
        ...
        GLib.idle_add(lambda: self.ui_editor_flowbox.foreach(lambda child: self.ui_editor_flowbox.remove(child)))
        GLib.idle_add(lambda: self.ui_editor_others_flowbox.foreach(lambda child: self.ui_editor_others_flowbox.remove(child)))
        GLib.idle_add(lambda: self.ui_editor_side_flowbox.foreach(lambda child: self.ui_editor_side_flowbox.remove(child)))

        for editor_app in self.Server.ediapplist[:1]:
        ...
        for editor_app in self.Server.ediapplist[1:3]:
            ...
            GLib.idle_add(listbox.get_style_context().add_class, "pardus-software-listbox-mostdown")
            if style == 1:
                GLib.idle_add(self.ui_editor_others_flowbox.insert, listbox, -1)
            elif style == 2:
                GLib.idle_add(self.ui_editor_side_flowbox.insert, listbox, -1)


        GLib.idle_add(self.ui_editor_flowbox.show_all)
        if style == 1:
            GLib.idle_add(self.ui_editor_others_flowbox.show_all)
        elif style == 2:
            GLib.idle_add(self.ui_editor_side_flowbox.show_all)
    ...
    def setAnimations(self):
        if self.UserSettings.config_ea:
            ...
            self.ui_pardusapps_stack.set_transition_type(Gtk.StackTransitionType.SLIDE_UP_DOWN)
            self.ui_pardusapps_stack.set_transition_duration(200)
    ...
    def on_mdabutton_clicked(self, button):
        ...
        self.SubCatCombo.set_visible(False)
        self.menubackbutton.set_sensitive(True)
        if self.ui_sortby_combo.get_active() != 1:
        ...
        self.NavCategoryLabel.set_text(_("all").title())
        if self.ui_sortby_combo.get_active != 1:
            self.ui_sortby_combo.set_active(1)
    ...
    def on_mrabutton_clicked(self, button):
        ...
        self.SubCatCombo.set_visible(False)
        self.menubackbutton.set_sensitive(True)
        if self.ui_sortby_combo.get_active() != 2:
        ...
        self.NavCategoryLabel.set_text(_("all").title())
        if self.ui_sortby_combo.get_active != 2:
            self.ui_sortby_combo.set_active(2)
        if not self.ui_showall_button.get_active():
            self.ui_showall_button.set_active(True)
        # self.PardusCategoryFilter.refilter()
        self.ui_pardusapps_flowbox.invalidate_filter()
    ...
    def on_labutton_clicked(self, button):
        ...
        self.SubCatCombo.set_visible(False)
        self.menubackbutton.set_sensitive(True)
        if self.ui_sortby_combo.get_active() != 3:
        ...
        self.NavCategoryLabel.set_text(_("all").title())
        if self.ui_sortby_combo.get_active != 3:
            self.ui_sortby_combo.set_active(3)
        if not self.ui_showall_button.get_active():
            self.ui_showall_button.set_active(True)
        # self.PardusCategoryFilter.refilter()
        self.ui_pardusapps_flowbox.invalidate_filter()
